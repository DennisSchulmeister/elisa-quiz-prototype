...
<!--
@component
Main page with the chat conversation and interactive activities.
-->
<script lang="ts">
    import Chat           from "./Chat.svelte"
    import Quiz           from "../../activities/quiz/Quiz.svelte"
...
<div id="menu">
    ...
    <a href="#/reset-history">{$i18n.Chat.ResetHistory.MenuEntry}</a>
</div>
